...
import {
  GENERATED_TALENT_DATA_PROVENANCE,
  GENERATED_TALENT_TREES,
} from "./generated";

export const INSTALLED_TALENT_SNAPSHOTS: readonly TalentTreeSnapshot[] =
  Object.entries(GENERATED_TALENT_TREES).map(([specId, packedNodes]) => ({
